        ...
        if sta_opts=='Vouching, Verification, Review': 
            ...
            if ds=="---":
                ...
                if reports=="Reports by Data Set ":
                    ...
                    with col2:
                        ...
                        auditdf_1=auditdf_1.style.set_properties(**{'background-color': 'AliceBlue', 'color': 'darkblue'})
                    ...
                    with col2:
                        auditdf_r=auditdf_r.style.set_properties(**{'background-color': 'AliceBlue', 'color': 'darkblue'})
            ...
            if not df_pendingObservations.empty:
                ...
                if reports2=="Observations Summary ":
                    ...
                    with col2:
                                df_summ=df_summ.style.set_properties(**{'background-color': 'AliceBlue', 'color': 'darkblue'})
                    ...
                    with c2:
                        df_head=df_head.style.set_properties(**{'background-color': 'AliceBlue', 'color': 'darkblue'})
