            ...
            try:
                ...
                if uploaded_file is not None:
                    ...
                    if ftype=='CSV':
                        ...
                        payload = st.text_area("Enter Payload",key="apipayload",placeholder="IF Dictionory- text must be in { curly brackets}; IF Text- without Quotes")
                    ...
                    if dataframe is not None:
                        ...
                        if 'Index' in dataframe.columns or 'index' in dataframe.columns:
                            ...
                            message=f'Column name with "Index" or "index" not allowed...Please change colum Name'
                        else:
                        ...
                        if spchr==True:
                            ...
                            message=substring1
                                ...
                                if ftype=='CSV':
                                    ...
                                    with c2:
                                        footer_row=st.number_input("No of Rows to skip from Bottom",min_value=0,value=0,key="footerrowcsv",help="for these rows from Bottom of Table, Data will be imported.")
            ...
            if ds_name=="---":
                ...
                if ds_name=="---":
                    ...
                    with st.expander("View Verification Criteria"):
                            ...
                            veri_df=get_verification(ds_name,int(st.session_state['AuditID']))
                            veri_df=veri_df.style.set_properties(**{'background-color': 'AliceBlue', 'color': 'darkblue'})
                            st.dataframe(veri_df)
