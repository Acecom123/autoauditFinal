            ...
            if selected:
                ...
                with placeholder.container():
                    ...
                    if selected[0]['Compliance_Status']=="Open":
                        with st.expander("Update Observations...",expanded=True): 
...
def show_audit():
    ...
    with audit_container:
        ...
        with st.sidebar.markdown("# Audit"):
            sel_option= st.radio("Select Option",('Planning','Documents & Info.','Audit- Vouching, Verification, Review','Observations for Audit Check List','Close Audit'),key='raiodmainop')
